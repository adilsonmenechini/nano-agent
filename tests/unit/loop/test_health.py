...
class TestStabilityMonitor:
    ...
    def test_detect_oscillation_anomaly(self):
        ...
        oscillation = [
            a for a in anomalies if a.fault_type == FaultCategory.OSCILLATION
        ]
    ...
    def test_detect_error_spike(self):
        ...
        anomalies = monitor.detect_anomalies(signal)
        error_spike = [
            a for a in anomalies if a.fault_type == FaultCategory.ERROR_SPIKE
        ]
    ...
    def test_detect_context_overflow(self):
        ...
        anomalies = monitor.detect_anomalies(signal)
        overflow = [
            a for a in anomalies if a.fault_type == FaultCategory.CONTEXT_OVERFLOW
        ]
